...
<body style="background-color: #FEEEE9">
	...
	<div class="row">
		...
		<div class="col-md-4" style="border: 2px solid grey; border-radius: 2rem;">
			<br>
			<form action="findUserIdProcess.jsp" method="post" name="findId">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="phone" name="phone" placeholder="연락처를 입력해주세요 (-제외)">
				</div>
				<button type="button" class="btn btn-danger btn-rounded waves-effect btn-lg btn-block" onclick="checkform()">찾기</button>
			</form>
