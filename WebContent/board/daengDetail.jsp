				...
				<div class="card" style="background-color: rgba(255, 238, 212, 0.445);">
					<div class="card-header" style="background-color: rgb(253, 77, 77);">
						<div class="row">
							...
							<div>
								<a style="position: absolute; left; color: white; text-shadow: 1px 1px 1px gray; font-size: 13px; vertical-align: middle;">조회수</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="card-body" style="background-color: white; padding-bottom: 50px;">
					<h5 class="card-title" style="height: 400px;">
						<div class="row">
							...
							<div class="col-sm-8">
								<div class="row">
									<img src="dog2.jpg" style="float: center;" alt="...">
								</div>
								<div class="row">삐삡</div>
							</div>
						</div>
					</h5>
