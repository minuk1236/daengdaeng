		...
		<div class="col-md-12">
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination justify-content-center font_color">
					<li class="page-item disabled"><a class="page-link font_color" href="#" tabindex="-1" aria-disabled="true">Previous</a></li>
					...
					<li class="page-item"><a class="page-link font_color" href="#">Next</a>
					</li>
				</ul>
			</nav>
		</div>
